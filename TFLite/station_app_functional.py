...
#path_models = r'C:\Users\aquacorp\Desktop\modelos_tflite\chiva_for_tflite' # Ubicacion de los modelos en la estacion
#path_image = r'C:\Users\aquacorp\Desktop\Imagenes\Chiva_pozo_entrada\muestreo/20240815061249.tif' # Imagen de turno
path_models = r'C:\Users\aquacorp\Desktop\modelos_tflite/donhierro_for_tflite_prueba_unos'
path_image = r'C:\Users\aquacorp\Desktop\Imagenes\DonHierro\muestreo/20231021092852.jpg'
path_image = r'C:\Users\aquacorp\Desktop\control_img.jpg'
...
if 'modelo_AN' in model_list:
    ...
    if mse > config['anomaly_thresh']: # Caso de imagen anomala
        ...
        dict_param = get_params_predictions(dict=dict_param, model_list=model_list, path_models=path_models, path_image=path_image)
